...
const navListControls: PlaygroundControl[] = [
  { name: 'size', type: 'size', defaultValue: 'md' },
  { name: 'spacing', type: 'select', options: ['none', 'sm', 'md', 'lg'], defaultValue: 'sm' },
];

const navListCodeTemplate = (props: Record<string, string>) => {
  return `<NavList size="${props.size}" spacing="${props.spacing}">
  <NavListItem to="/home">Home</NavListItem>
  <NavListItem to="/docs">Documentation</NavListItem>
  <NavListItem to="/settings">Settings</NavListItem>
</NavList>`;
};
...
const sections = [
  ...
  { id: 'basic', title: 'Basic Navigation', level: 3 },
  { id: 'icons', title: 'With Icons', level: 3 },
  { id: 'badges', title: 'With Badges', level: 3 },
  { id: 'disabled', title: 'Disabled Items', level: 3 },
  { id: 'sizes', title: 'Sizes', level: 3 },
  { id: 'router', title: 'React Router Integration' },
      ...
      <div className="flex gap-8">
        <div className="flex-1">
          <Section title="Playground" id="playground">
            <Playground controls={navListControls} codeTemplate={navListCodeTemplate}>
              {(props) => (
                <div className="max-w-xs border border-neutral-200 rounded-lg p-4">
                  <NavList
                    size={props.size as Size}
                    spacing={props.spacing as 'none' | 'sm' | 'md' | 'lg'}
                  >
          ...
          <Section title="Examples" id="examples">
            <div className="space-y-8">
              <Section
                ...
                titleLevel="h3"
                id="basic"
                code={`<NavList size="sm" spacing="sm">
  <NavListItem to="/styled/navlist">NavList (Current)</NavListItem>
  <NavListItem to="/styled/list">List</NavListItem>
  <NavListItem to="/styled/accordion">Accordion</NavListItem>
</NavList>`}
