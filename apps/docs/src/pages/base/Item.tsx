import { Typography, Sheet, Badge } from '@base-joy/ui-components';
import {
  Item,
  ItemStart,
  ItemContent,
...
export function BaseItemPage() {
  return (
    <div className="max-w-4xl">
      <header className="mb-8">
        <div className="flex items-center gap-2 mb-2">
          <Typography level="h1">Item</Typography>
          <Badge variant="outlined" color="neutral" size="sm">Base</Badge>
        </div>
        ...
        <div className="mt-4">
          ...
          >
            Looking for the styled version? View Item in Components &rarr;
          </Link>
        </div>
      </header>
...
import { itemVariants } from '@base-joy/ui-base';
...
<div className={itemVariants({ size: 'lg', interactive: true })}>
  Using variants directly
      ...
      <Section title="Context">
        ...
        <Sheet variant="outlined" color="neutral" className="font-mono text-sm whitespace-pre">
{`import { ItemContext, useItemContext } from '@base-joy/ui-base';
