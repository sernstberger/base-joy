...
export const navigation: NavSection[] = [
  ...
  },
  {
    ...
    items: sortByLabel([
      ...
      { label: 'AlertDialog', path: '/styled/alert-dialog', baseUiUrl: 'https://base-ui.com/react/components/alert-dialog' },
      ...
      { label: 'Collapsible', path: '/styled/collapsible', baseUiUrl: 'https://base-ui.com/react/components/collapsible' },
      ...
      { label: 'Dialog', path: '/styled/dialog', baseUiUrl: 'https://base-ui.com/react/components/dialog' },
      ...
      { label: 'Menu', path: '/styled/menu', baseUiUrl: 'https://base-ui.com/react/components/menu' },
      { label: 'Meter', path: '/styled/meter', baseUiUrl: 'https://base-ui.com/react/components/meter' },
      { label: 'NavigationMenu', path: '/styled/navigation-menu', baseUiUrl: 'https://base-ui.com/react/components/navigation-menu' },
      ...
      { label: 'Popover', path: '/styled/popover', baseUiUrl: 'https://base-ui.com/react/components/popover' },
      { label: 'PreviewCard', path: '/styled/preview-card', baseUiUrl: 'https://base-ui.com/react/components/preview-card' },
      { label: 'Progress', path: '/styled/progress', baseUiUrl: 'https://base-ui.com/react/components/progress' },
      { label: 'Radio', path: '/styled/radio', baseUiUrl: 'https://base-ui.com/react/components/radio-group' },
      { label: 'ScrollArea', path: '/styled/scroll-area', baseUiUrl: 'https://base-ui.com/react/components/scroll-area' },
      ...
      { label: 'Tabs', path: '/styled/tabs', baseUiUrl: 'https://base-ui.com/react/components/tabs' },
      ...
      { label: 'Toolbar', path: '/styled/toolbar', baseUiUrl: 'https://base-ui.com/react/components/toolbar' },
      { label: 'Tooltip', path: '/styled/tooltip', baseUiUrl: 'https://base-ui.com/react/components/tooltip' },
